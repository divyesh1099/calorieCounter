...
class UserProfile(models.Model):
    ...
    target_daily_calories = models.PositiveIntegerField(default=2000)  # User's target calorie intake per day
    total_calories_consumed = models.PositiveIntegerField(default=0)  # Cumulative total for all days
    joined_date = models.DateField(auto_now_add=True)

    # Macronutrient targets
    target_protein = models.FloatField(default=0)  # in grams
    target_carbs = models.FloatField(default=0)  # in grams
    target_fat = models.FloatField(default=0)  # in grams
